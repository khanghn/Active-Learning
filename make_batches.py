...
checkpoint = torch.load('checkpoint/rotation_100.0.pth')
...
if __name__ == "__main__":
    ...
    for i in range(10):
        ...
        sample5000 = sort_index[i*356:(i+1)*356]
        ...
        root = '/home/hungld11/Intern/khanghn1/PT4AL'
        print(root)
        for k in sample5000:
            with open(s, 'a') as f:
                f.write(name_2[k].split('/')[3]+'\n')
