...
transform_train = transforms.Compose([
    ...
    transforms.RandomCrop(512, padding=120),
...
def train(epoch):
    ...
    correct = 0
    total = 0
    for batch_idx, (inputs, inputs1, inputs2, inputs3, targets, targets1, targets2, targets3, _) in enumerate(trainloader):
...
def test(epoch):
    ...
    if acc > best_acc:
        ...
        torch.save(state, f'./checkpoint/rotation_{acc}.pth')
        best_acc = acc
